  ...
  return (
    <div className="p-3 sm:p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 sm:gap-6">
        {/* قائمة المركبات */}
        <div className="lg:col-span-1 space-y-3 max-h-75 sm:max-h-100 lg:max-h-150 overflow-y-auto">
          {loading ? (
              ...
              >
                ...
                <div className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm">
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">السائق/المالك:</span>
        ...
        <div className="lg:col-span-4 rounded-lg min-h-100 h-100 sm:min-h-125 sm:h-125 lg:min-h-150 lg:h-150 relative overflow-hidden border-2 border-gray-300 shadow-lg">
          <MapComponent
            vehicles={vehicles}
      ...
      {selectedVehicle && (
        <div className="mt-3 sm:mt-4 md:mt-6 p-2.5 sm:p-3 md:p-4 lg:p-5 bg-linear-to-r from-blue-50 to-blue-100 border border-blue-300 sm:border-2 rounded-lg shadow-sm sm:shadow-md">
          <h3 className="font-bold text-blue-900 mb-2 sm:mb-3 md:mb-4 text-sm sm:text-base md:text-lg flex items-center gap-1.5 sm:gap-2">
            ...
            <span className="wrap-break-word text-xs sm:text-sm md:text-base">تفاصيل المركبة /الموبايل: {selectedVehicle.name}</span>
          </h3>
