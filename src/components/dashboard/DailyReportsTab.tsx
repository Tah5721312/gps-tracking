          ...
          <div className='flex flex-wrap gap-4 items-end'>
            <div>
              ...
              <select
                ...
                className='px-8 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 min-w-37.5'
              >
          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-3xl font-bold'>
                {stats.totalDistance.toFixed(1)} كم
              </p>
            </div>
        ...
        <div className='bg-linear-to-br from-purple-500 to-purple-600 text-white rounded-lg p-6 shadow-lg'>
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-3xl font-bold'>
                {Math.round(stats.avgSpeed)} كم/س
              </p>
            </div>
