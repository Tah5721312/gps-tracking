    ...
    <header className="">
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 items-center my-10">
        ...
        <div
          ...
          dir="rtl"
        >
          <h1 className="card-text text-[20px] lg:text-[40px] font-bold leading-11.25 lg:leading-15 w-full max-w-full whitespace-nowrap text-gray-800">
            مراقبة مباشرة لأسطول المركبات / الموبايلات
          </h1>
