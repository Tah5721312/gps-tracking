    ...
    <section className=' flex items-center justify-center px-4 py-12'>
      <div className='w-full max-w-md'>
        ...
        <div className='text-center mb-8'>
          <div className='inline-flex items-center justify-center w-16 h-16 bg-linear-to-br from-indigo-500 to-cyan-600 rounded-2xl mb-4 shadow-lg'>
            <svg
        ...
        <p className='text-center text-sm text-gray-500 mt-8'>
          All location data is securely encrypted
        </p>
      </div>
    </section>
  );
